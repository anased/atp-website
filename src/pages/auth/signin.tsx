...
export default function SignIn({ providers, callbackUrl }: SignInProps) {
  ...
  return (
    <Layout>
      <Head>
        <title>Sign In | ATP Medical Education</title>
      </Head>
            ...
            .map((provider) => (
              <div key={provider.id} className="mt-4">
                <button
                  ...
                  className="w-full flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
